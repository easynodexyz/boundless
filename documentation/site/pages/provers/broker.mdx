...
3. Enabling `race_mode` skips most preflight and profitability checks for the fastest possible lock-in. Combine with `disable_profitability_checks` during incentive campaigns.
